        ...
        register.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (useridtf.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null, "Worker Id is required");
                    return;
                ...
                try{
                    conn c = new conn();
                    String query1 = "UPDATE `workerhistory` SET `active`='no' where `workerid` = " + useridtf.getText() + " and `password` = '" + pass.getText() + "'";
                    String query2 = "UPDATE `login` SET `active`='no' where `userid` = " + useridtf.getText() + " and `password` = '" + pass.getText() + "' and `type` = 'Worker'";
