...
public class patientDetail {
    JFrame frame;
    JLabel heading, logo, head, name, dieases, age, gender, joindate;
    JTextField search;
    JButton go, back;
    patientDetail(){
        ...
        head = new JLabel("Patient Details");
        ...
        dieases = new JLabel("Dieases");
        dieases.setBounds(570, 180, 200, 30);
        dieases.setFont(new Font("Arial", Font.PLAIN, 20));
        frame.add(dieases);
        ...
        diseases.setBounds(570, 220, 200, 30);
        ...
        go.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    String query1 = "select * from patienthistory where username = '" + n + "'";
                    ...
                    while(rs.next()){
                        ...
                        diseases.setText(rs.getString(10));
