...
public class doctorRegister {
    JFrame frame;
    JLabel heading, logo, signup, name, email, father, phone, password, gender, dob, state;
    ...
    doctorRegister() {
        ...
        register.setBounds(325, 550, 250, 30);
        ...
        reset.setBounds(325, 600, 120, 30);
        ...
        cancel.setBounds(455, 600, 120, 30);
        ...
        register.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (uname.getText().isEmpty()) {
                    ...
                    return;
                } else if (Objects.equals(statetf.getSelectedItem(), "Select state")) {
