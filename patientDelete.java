    ...
    patientDelete(){
        ...
        register.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    conn c = new conn();
                    String query1 = "UPDATE `patienthistory` SET `active`='no' where `patientid` = " + useridtf.getText() + " and `password` = '" + pass.getText() + "'";
                    String query2 = "UPDATE `login` SET `active`='no' where `userid` = " + useridtf.getText() + " and `password` = '" + pass.getText() + "' and `type` = 'Patient'";
